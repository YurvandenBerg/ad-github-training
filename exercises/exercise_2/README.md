Nu je kan clonen, committen en pushen gaan we met een branch en merge conflicts werken. Iedereen uit je groepje
opent een branch op het functie bestand dat je in de vorige opdracht heb gemaakt. Maak een branch aan met de naam opdracht_2_NAAM (NAAM is jouw naam). Dit doe je door gebruik te maken van `git branch opdracht_2_NAAM`. Nu typ je 
...
In deze nieuwe branch ga je aan de slag met de functie die je in de vorige opdracht gemaakt hebt. Zorg dat je in je code editor de meest recente versie van de repo hebt die de oplossing van opdracht 1 bevat.

We hebben inmiddels een functie die het aantal likes telt. De likes op je Facebook posts zijn zóóóó 2018 geworden. Het enige waar jij Facebook nog voor gebruikt is de verjaardag van je vrienden en collega's. 
...
```
['Linus', '1969-12-28']  --> "Unfortunately, today is not the birthday of Linus"
['Gerda', '1980-01-27']  --> "Today is Gerda's birthday!"
```
...
main branch plaatsvinden. Maak een pull request, review deze en merge hem vervolgens met de main branch. Probeer hetzelfde met de branch van de andere opdracht maker en kijk wat er gebeurt. Probeer het merge conflict op te lossen. We zijn benieuwd naar je uitwerking.
